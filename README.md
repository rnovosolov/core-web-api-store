...
A set of sample requests for Postman is available in the file [store api.postman_collection.json](https://github.com/rnovosolov/core-web-api-store/blob/master/store%20api.postman_collection.json), or you can also import the collection directly using the [Postman link](https://api.postman.com/collections/22858656-d0045d44-8c26-40f8-a53e-9072e9b68a37?access_key=PMAT-01H86WATKXQA7JS5PSPM43AT4W).
